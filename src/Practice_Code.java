...
public class Practice_Code {
    public static Map<String,Integer> processData(ArrayList<String> array) {
        ...
        Map<String, Integer> maxEntry = null;
        int maxValueInMap=(Collections.max(retVal.values()));

        for (Entry<String, Integer> entry : retVal.entrySet()) {  // Iterate through HashMap
            if (entry.getValue()==maxValueInMap) {
                maxEntry.put(entry.getKey(), entry.getValue()); // Print the key with max value
            }
        }
       return maxEntry;
    }
